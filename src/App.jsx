...
function App() {
    ...
    return (
        <main className="p-5 md:p-10 text-white flex flex-col justify-center items-center gap-4 md:gap-8 w-full h-screen bg-gray-900">
            {
                index === 216 ?
                ...
                :
                    <>
                        <h1 className="text-lg md:text-2xl font-semibold">Quizz Drapeaux du Monde</h1>

                        <img className="h-[200px] md:h-[400px]" alt="Drapeau du pays mystère" src={current?.fields?.flag}/>
                        ...
                        <div className="flex gap-2 md:gap-4 w-full">
                            ...
                            <form onSubmit={handleSubmit} className="flex flex-col md:flex-row gap-2 md:gap-4 w-full items-center">
